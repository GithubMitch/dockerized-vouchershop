  ...
  <div class="select" >
    ...
    <div class="select-styled"  :class="{active:isActive}" @click="toggleActive($event);">
      <div class="option selected">
          <div class="visual"><img :src="`@/assetslogos/${optionType}${ !select.pmname && !options[0].pmname ? options[0].pmsubName.replace(/ /g, '_') : !select.pmname && !options[0].pmsubName ? options[0].pmname : select.pmname}.png`" /></div>
    ...
    <ul  class="select-options"  :class="{active:isActive}">
      <li v-for="(option, i) of options"
          ...
          <div class="option selected">
              <div class="visual"><img :src="`@/assetslogos/${optionType}${option.pmname || option.pmsubName.replace(/ /g, '_')}.png`" /></div>
